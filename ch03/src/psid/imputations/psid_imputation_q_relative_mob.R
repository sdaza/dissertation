...
# explore imputations
savepdf("output/plots/psid_q_relative_mob_imp_iterations")
...
simp = imp
savepdf("output/plots/psid_q_relative_mob_imp_values")
...
saveRDS(imp, file = "output/data/psid_q_relative_mob_imputations.rds")
