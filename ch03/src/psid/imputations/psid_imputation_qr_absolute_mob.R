...
vars = c("absolute_mob_resid", "gini_resid", "log_population", "log_county_income", "log_income_adj", 
...
# explore imputations
savepdf("output/plots/psid_qr_absolute_mob_imp_iterations")
...
simp = imp
savepdf("output/plots/psid_qr_absolute_mob_imp_values")
...
saveRDS(imp, file = "output/data/psid_qr_absolute_mob_imputations.rds")
