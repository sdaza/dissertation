...
ldat = readRDS("output/data/psid_data_ready_for_imputation.rds")
names(ldat)
table(ldat$race)
...
var_labels = c("Male", "Age last interview", "Birth year",
               "White", "Black", "Other",
               "Weighted less than 55 oz", "Mother married at birth",
...
var_names = c("rev_health", "bmi", "depression", "smoking", "smoking_number")
