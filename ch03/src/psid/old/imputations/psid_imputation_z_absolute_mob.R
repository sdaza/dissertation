...
# explore imputations
savepdf("output/plots/psid_z_absolute_mob_imp_iterations")
...
simp = imp
savepdf("output/plots/psid_z_absolute_mob_imp_values")
...
saveRDS(imp, file = "output/data/psid_z_absolute_mob_imputations.rds")
