...
# load saved results
z_relative_mob_results = readRDS("ch03/output/data/nlsy97_z_relative_mob_results.rds")
z_absolute_mob_results = readRDS("ch03/output/data/nlsy97_z_absolute_mob_results.rds")
z_gini_results = readRDS("ch03/output/data/nlsy97_z_gini_resultss.rds")
