...
test = mice::complete(imp_q_relative_mob, 1)
table(test$q_relative_mob)
table(test$q_relative_mob_resid)
table(test$q_absolute_mob)
...
numerator = longText("
    ...
    baseline_q_relative_mob + baseline_q_gini + baseline_log_population +
    baseline_log_county_income + baseline_z_prop_black +
    lag_q_relative_mob) + as.factor(stime)
")
...
denominator = longText("
    ...
    lag_q_relative_mob + lag_q_gini + lag_log_county_income +
...
predictors = longText(
    "average_q_relative_mob + male + ethnicity +
     ...
     baseline_q_gini + baseline_log_population +
     baseline_log_county_income + baseline_z_prop_black
")
