...
exposure = c("q_relative_mob", "q_gini")
...
saveRDS(imp, "output/data/nlsy97_q_relative_mob_imputations.rds")
# send message to slack
slackr::text_slackr(paste("Imputation q_relative_mob finished at", Sys.time()))
...
savepdf("output/plots/nlsy97_q_relative_mob_imp_values")
