...
exposure = c("q_absolute_mob_resid", "q_gini_resid")
...
saveRDS(imp, "output/data/nlsy97_qr_absolute_mob_imputations.rds")
# send message to slack
slackr::text_slackr(paste("Imputation qr_absolute_mob finished at", Sys.time()))

# explore quality of imputations
savepdf("output/plots/nlsy97_qr_absolute_mob__imp_iterations")
