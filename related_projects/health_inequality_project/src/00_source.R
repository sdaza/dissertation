...
source('related_projects/health_inequality_project/src/03_relative_mob_models_by_quartile.R')

# run absolute mobility models by quartile
source('related_projects/health_inequality_project/src/04_absolute_mob_models_by_quartile.R')

# run relative mobility robust models by quartile
source('related_projects/health_inequality_project/src/05_robust_relative_mob_models_by_quartile.R')
