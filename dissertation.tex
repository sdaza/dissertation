...
% quotes
\newcommand{\chapquote}[3]{\begin{quotation} \textit{#1} \end{quotation} \begin{flushright}#2\end{flushright}\vspace{2cm}}
...
\vspace{60pt}
\noindent Date of final oral examination: 02/26/2021\\
\\
