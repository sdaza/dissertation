...
# R < 00dissertation/ch02/src/03_cdc_inla_age_cause_models_pcprior_1_10.R > 00dissertation/ch02/src/03_cdc_inla_age_cause_models_pcprior_1_10.log --no-save  &
...
# covariate adjusment + varying coefficients (1)
...
#           f(mob_cause, z_relative_mob, model = 'iid', hyper=pcprior) +
#           f(gini_cause, z_gini, model = 'iid', hyper=pcprior)
#
...
#
# savepdf('output/m1_effects_age_cause_dist_pcprior_10_01')
# plot_dist_fixed_random_sim(sim_m1,
#   fixed=c('z_relative_mob', 'z_gini'),
#   random=c('mob_cause', 'gini_cause'),
#   names_group=cause_groups,
#   names_random=c('Relative Mobility', 'Gini')
#     )
# dev.off()
#
# savepdf('output/w1_effects_age_cause_dist_pcprior_10_01')
...
# print(plot_fixed_coeff(m2, coeff=c('z_relative_mob', 'z_gini'),
#   coeff_labels=c('Relative Mobility', 'Gini'), exponential=TRUE) + xlim(0.95,1.15) + ylim(NA, 60) + xlab('\nPosterior distribution'))
# dev.off()
#
# savepdf('output/w_coeff_age_cause_pcprior_1_10_1')
# print(plot_fixed_coeff(w2, coeff=c('z_relative_mob', 'z_gini'),
#   coeff_labels=c('Relative Mobility', 'Gini'), exponential=TRUE) + xlim(0.95,1.15) + ylim(NA, 60) + xlab('\nPosterior distribution'))
# dev.off()
...
# print(plot_fixed_coeff(m3, coeff=c('z_relative_mob', 'z_gini'),
#   coeff_labels=c('Relative Mobility', 'Gini'), exponential=TRUE) + xlim(0.95,1.15) + ylim(NA, 60) + xlab('\nPosterior distribution'))
# dev.off()
#
# savepdf('output/w_coeff_age_cause_pcprior_1_10_2')
# print(plot_fixed_coeff(w3, coeff=c('z_relative_mob', 'z_gini'),
#   coeff_labels=c('Relative Mobility', 'Gini'), exponential=TRUE) + xlim(0.95,1.15) + ylim(NA, 60) + xlab('\nPosterior distribution'))
# dev.off()
...
# print(plot_fixed_coeff(m5, coeff=c('z_relative_mob', 'z_gini'),
#   coeff_labels=c('Relative Mobility', 'Gini'), exponential=TRUE) + xlim(0.95,1.15) + ylim(NA, 60) + xlab('\nPosterior distribution'))
# dev.off()
#
# savepdf('output/w_coeff_age_cause_pcprior_1_10_4')
# print(plot_fixed_coeff(w5, coeff=c('z_relative_mob', 'z_gini'),
#   coeff_labels=c('Relative Mobility', 'Gini'), exponential=TRUE) + xlim(0.95,1.15) + ylim(NA, 60) + xlab('\nPosterior distribution'))
# dev.off()
#
