...
# R < 00dissertation/ch02/src/02_cdc_inla_age_race_models_pcprior_10_01.R > 00dissertation/ch02/src/02_cdc_inla_age_race_models_pcprior_10_01.log  --no-save  &
...
#           f(mob_race, z_relative_mob, model = 'iid', hyper=pcprior) +
...
#
# savepdf('output/m1_effects_age_race_dist_pcprior_1_10')
...
# dev.off()
#
# savepdf('output/w1_effects_age_race_dist_pcprior_1_10')
