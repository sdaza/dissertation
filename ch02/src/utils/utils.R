...
#                          # two coefficients max
#                          coeff = NULL,
#                          coeff_labels = NULL,
#                          groups_labels = NULL) {

#     coeff = paste0(coeff, ':1')
#     f = data.table()
...
# # plot fixed effects using simulated data
...
# # plot distributions random-fixed using simulated data
# plot_dist_fixed_random_sim = function(sim_data,
#                                       fixed,
#                                       random,
#                                       names_random = NULL,
#                                       names_group = NULL,
